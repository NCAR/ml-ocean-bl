...
class VLCNN(keras.Model):
    ...
    where X = np.vstack(X[0], X[1], ...). Noise is estimated by a linear relationship.
    ...
    """
    def __init__(self, input_dim, n_features, batch_norm = True, num_layers = 5, Dropout = 0.1, num_dense_layers = 0, location = "EPO", dtype='float64', **kwargs):
        super(VLCNN, self).__init__(name='linear_variational_convolutional_neural_network', dtype='float64', **kwargs)
